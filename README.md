...
3. **Instale as bibliotecas necessárias** utilizando o método descrito acima ou o método de sua preferência. Preste atenção especial à biblioteca **GRAPHVIZ**, pois costuma apresentar dificuldades durante a instalação, especialmente para usuários do Windows. Se a biblioteca **GRAPHVIZ** apresentar problemas, siga as instruções da próxima seção.
